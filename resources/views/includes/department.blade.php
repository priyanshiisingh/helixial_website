    ...
    <section class="service-section" id="department">
            ...
            <div class="services-content mb-0 align-items-center">
                <div data-aos="fade-down" data-aos-duration="3000" style="margin-bottom: 0;">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        <h3 class="service-subtitle mb-0 me-3"><span>Microbiology :</span> Precision diagnostic</h3>
                ...
                <div id="cancerFind" class="tm-blog-section tm-blog-left-sidebar">
                    <div class="container">
                        <div class="my-3" data-aos="fade-left" data-aos-duration="3000"><img
        ...
        <div class="container mt-5">
            <div class="row align-items-center">
                <h2 class="service-title text-center mb-3"><strong>Liquid Biopsy</strong></h2>
            </div>
        </div>
        {{-- <div class="m-5">
        ...
        <div class="container mb-5">
            <div class="w-100" data-aos="fade-right " data-aos-duration="3000">
                ...
                <div class="alpha-content">
                    <div class="row">
                        <div class="col-md-6 text-center mb-4 mb-md-0 d-flex flex-column align-items-center justify-content-center"
                            data-aos="fade-up" data-aos-duration="3000">

                            <img src="{{ asset('assets/img/new/home/home_liquid_profiling.svg') }}"
                                alt="Liquid Biopsy Tube" class="img-fluid rounded">
                        </div>

                        <div class="col-md-6 d-flex flex-column justify-content-center" data-aos="fade-down"
                            data-aos-duration="3000">
                            <!-- CancerFind -->
                            <div class="biopsy-box mt-2 mb-3">
                                <p class="mb-1"><strong>CancerFind™</strong> is a revolutionary blood-based test for
                                    Multi-Cancer Early Detection (MCED). To identify the presence of various cancer
                                    types
                                    through a single, non-invasive blood draw.</p>
                                <div class="read-more-btn-reverse mt-2 mb-2">
                                    <span><a href="{{ route('pages.service.cancerFind') }}">READ MORE</a></span>
                                </div>
                            </div>
                            <!-- CancerDetect -->
                            <div class="biopsy-box mt-2 mb-3">
                                <p class="mb-1"><strong>CancerDetect™:</strong> Personalized Liquid Biopsy for early
                                    detection
                                    of cancer recurrence. With CancerDetect™, we bring next-generation cancer
                                    surveillance to
                            ...
                            <!-- AlphaLiquid100 -->
                            <div class="biopsy-box mt-2 mb-3">
                                <p class="mb-1"><strong>AlphaLiquid®100</strong> is an innovative, cutting-edge liquid
                                    biopsy
