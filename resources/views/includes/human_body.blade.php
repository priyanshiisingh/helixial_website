<div class="human-body">
    ...
    <svg data-position="arm" class="arm" xmlns="http://www.w3.org/2000/svg" width="156.344" height="119.25"
    ...
    <svg data-position="cheast" class="cheast" xmlns="http://www.w3.org/2000/svg" width="86.594" height="45.063"
    ...
    <svg data-position="stomach" class="stomach" xmlns="http://www.w3.org/2000/svg" width="75.25" height="107.594"
    ...
    <svg data-position="legs" class="legs" xmlns="http://www.w3.org/2000/svg" width="93.626" height="286.625"
...
<div id="description-box" style="display:none; position:absolute; top:0; left:0; background:#F8FFFE; padding:10px; border:1px solid #ccc; max-width:300px; z-index:10000;">
</div>
    ...
    window.onload = function () {
        ...
        for (let i = 0; i < pieces.length; i++) {
            ...
            _piece.onclick = function (t) {
                const pos = t.target.getAttribute('data-position') || t.target.parentElement.getAttribute('data-position');
                if (pos) document.getElementById('data').innerHTML = pos;
            };
        }
